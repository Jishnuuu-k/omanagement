      ...
      <div className="footer-container">
        ...
        <div className="footer-top">
          ...
          <div className="footer-col footer-brand">
            ...
            <p className="footer-tagline">
              Next-generation workforce management engineered for precision,
              built for scale. Track attendance and overtime with military-grade
              accuracy.
            </p>
          ...
          <div className="footer-col footer-newsletter">
            ...
            <p className="newsletter-text">
              Get system updates and feature releases delivered to your inbox.
            </p>
        ...
        <div className="footer-bottom">
          ...
          <div className="footer-copy">
            ...
            <span className="copy-year">2025</span>
            <span className="copy-text">OT MANAGEMENT SYSTEM</span>
            <span className="copy-dot">•</span>
